...
# Build both images
docker buildx build --platform linux/arm64 -t ${DOCKER_ID}/jsc-k3s-dashboard:arm64-latest -f ${DOCKER_PATH}/Dockerfile.arm64 code/app
docker build -t ${DOCKER_ID}/jsc-k3s-dashboard:latest -f ${DOCKER_PATH}/Dockerfile code/app
